...
public abstract class AdvanceDrawerLayout extends DrawerLayout {
...
//    }
   ...
   // abstract void updateSlideOffset(CardView child, Setting setting, float width, float slideOffset, boolean isLeftDrawer);
